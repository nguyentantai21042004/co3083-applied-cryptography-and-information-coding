...
\input{contents/1_cryptographic-hardness-and-real-world-implications}
\newpage
\input{contents/2_diffie-hellman-in-hostile-environments}
\newpage
\input{contents/3_elliptic-curve-security-engineering}
\newpage
\input{contents/4_applied-cryptography-case-studies}
